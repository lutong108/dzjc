 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.ServiceGuideOld", table = "V_JC_TA_SP_SERVICES_GUIDE_OLD", ds = "acceptdata", cache = false)
public class ServiceGuideOld {
