 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.SmUser", table = "TD_SM_USER", ds = "acceptdata")
public class SmUser implements Serializable {
	private static final long serialVersionUID = 2629041997840384L;
	/**
	 *用户ID
	 */
	@Column(id = "user_id", type = ColumnType.uuid, datatype = "string64")
	 ...
	 *用户密码
	 */
	@Column(id = "user_password", datatype = "string512")
	private java.lang.String userPassword;

	/**
	 *用户实名
	 */
	@Column(id = "user_realname", datatype = "string128")
	private java.lang.String userRealname;

	/**
	 *拼音
	 */
	@Column(id = "user_pinyin", datatype = "string128")
	private java.lang.String userPinyin;

	/**
	 *性别
	 */
	@Column(id = "user_sex", datatype = "string128")
	private java.lang.String userSex;

	/**
	 *家庭电话
	 */
	@Column(id = "user_hometel", datatype = "string128")
	private java.lang.String userHometel;

	/**
	 *公司电话
	 */
	@Column(id = "user_worktel", datatype = "string128")
	private java.lang.String userWorktel;

	/**
	 *公司地址
	 */
	@Column(id = "user_workaddress", datatype = "string128")
	private java.lang.String userWorkaddress;

	/**
	 *手机1
	 */
	@Column(id = "user_mobiletel1", datatype = "string128")
	private java.lang.String userMobiletel1;

	/**
	 *手机2
	 */
	@Column(id = "user_mobiletel2", datatype = "string128")
	private java.lang.String userMobiletel2;

	/**
	 *传真
	 */
	@Column(id = "user_fax", datatype = "string128")
	private java.lang.String userFax;

	/**
	 *OICQ
	 */
	@Column(id = "user_oicq", datatype = "string128")
	private java.lang.String userOicq;

	/**
	 *生日
	 */
	@Column(id = "user_birthday", datatype = "date")
	private java.sql.Date userBirthday;

	/**
	 *邮箱
	 */
	@Column(id = "user_email", datatype = "string128")
	private java.lang.String userEmail;

	/**
	 *住址
	 */
	@Column(id = "user_address", datatype = "string256")
	private java.lang.String userAddress;

	/**
	 *邮编
	 */
	@Column(id = "user_postalcode", datatype = "string10")
	private java.lang.String userPostalcode;

	/**
	 *身份证
	 */
	@Column(id = "user_idcard", datatype = "string64")
	private java.lang.String userIdcard;

	/**
	 *是否使用
	 */
	@Column(id = "user_isvalid", datatype = "bigdouble")
	private java.lang.Double userIsvalid;

	/**
	 *注册日期
	 */
	@Column(id = "user_regdate", datatype = "date")
	private java.sql.Date userRegdate;

	/**
	 *登陆次数
	 */
	@Column(id = "user_logincount", datatype = "bigdouble")
	private java.lang.Double userLogincount;

	/**
	 *用户类型
	 */
	@Column(id = "user_type", datatype = "string128")
	private java.lang.String userType;

	/**
	 *过期时间
	 */
	@Column(id = "past_time", datatype = "date")
	private java.sql.Date pastTime;

	/**
	 *开通时间
	 */
	@Column(id = "dredge_time", datatype = "string64")
	private java.lang.String dredgeTime;

	/**
	 *用户最后登陆时间
	 */
	@Column(id = "lastlogin_date", datatype = "date")
	private java.sql.Date lastloginDate;

	/**
	 *工作年限
	 */
	@Column(id = "worklength", datatype = "string64")
	private java.lang.String worklength;

	/**
	 *政治面貌
	 */
	@Column(id = "politics", datatype = "string128")
	private java.lang.String politics;

	/**
	 *登录IP
	 */
	@Column(id = "login_ip", datatype = "string20")
	private java.lang.String loginIp;

	/**
	 *证书key的唯一标识
	 */
	@Column(id = "cert_sn", datatype = "string64")
	private java.lang.String certSn;

	/**
	 *用户排序号
	 */
	@Column(id = "user_sn", datatype = "bigdouble")
	private java.lang.Double userSn;
	 ...
	 *备用字段5
	 */
	@Column(id = "remark5", datatype = "string128")
	 ...
	 *备用字段7
	 */
	@Column(id = "remark7", datatype = "string128")
	private java.lang.String remark7;

	/**
	 *备用字段8
	 */
	@Column(id = "remark8", datatype = "string128")
	private java.lang.String remark8;

	/**
	 *备用字段9
	 */
	@Column(id = "remark9", datatype = "string128")
	private java.lang.String remark9;

	/**
	 *备用字段10
	 */
	@Column(id = "remark10", datatype = "string128")
	 ...
	 * 设置是否使用
	 */
	public void setUserIsvalid(java.lang.Double userIsvalid) {
	 ...
	 * 获取是否使用
	 */
	public java.lang.Double getUserIsvalid() {
		return userIsvalid;
	}
	 ...
	 * 设置注册日期
	 */
	public void setUserRegdate(java.sql.Date userRegdate) {
	 ...
	 * 获取注册日期
	 */
	public java.sql.Date getUserRegdate() {
		return userRegdate;
	}
	 ...
	 * 设置登陆次数
	 */
	public void setUserLogincount(java.lang.Double userLogincount) {
	 ...
	 * 获取登陆次数
	 */
	public java.lang.Double getUserLogincount() {
	 ...
	 * 设置过期时间
	 */
	public void setPastTime(java.sql.Date pastTime) {
	 ...
	 * 获取过期时间
	 */
	public java.sql.Date getPastTime() {
		return pastTime;
	}
	 ...
	 * 设置用户排序号
	 */
	public void setUserSn(java.lang.Double userSn) {
		this.userSn = userSn;
	}
	 ...
	 * 获取用户排序号
	 */
	public java.lang.Double getUserSn() {
		return userSn;
	}
