 ...
 *湘西州村级办件统计明细
 */
public class VillageLevelStatisticsExportSon {
	...
	public void excelExport(String titleName, List<Ta_Jc_Sum_Xxylttj> busList) {
		// 下层表头文字
		String[] coloumItems1 = { "受理单位","事项类型","事项名称", "受理数", "办结数","乡镇审核量","县级审核量"};
		// 下层表头坐标，顺序对应下层表头文字
		String[] number1 = { "1,1,1,1", "1,1,2,2", "1,1,3,3", "1,1,4,4","1,1,5,5","1,1,6,6","1,1,7,7"};
		// 开始写表格
