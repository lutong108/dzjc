 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.SuperviseHuanJieTemp", table = "ta_jc_supervise_huanjie_temp", ds = "acceptdata", cache = false)
public class SuperviseHuanJieTemp {
	/**
	 *业务ID
	 */
