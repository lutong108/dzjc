...
import com.chinacreator.dzjc_ruleEngine.web.rest.ShiXiangBanJianStatisticsController;
import com.chinacreator.util.FilesUtil;

public class ShiXiangBanJianStatisticsInfoServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = null;
		if ("1".equals(type)) {//导出Excel
			
			String titleName = new ShiXiangBanJianStatisticsController().expExcel(org_xzqm,beginDate,endDate,parentCode,viewFlag);
			path = srcPath + titleName + ".xls";
			
		} else if("2".equals(type)) {//导出Word(根据需求，待完善)
