...
public class FenLeiShiXiangBanJianStatisticsInfoServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			// Excel导出
			String titleName = new TongJiController().exportFenLeiShiXiangBanJianStatisticsInfo(type, orgId, beginDate, endDate);
