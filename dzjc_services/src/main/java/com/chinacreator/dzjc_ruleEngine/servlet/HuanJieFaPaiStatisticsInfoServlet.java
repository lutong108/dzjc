...
public class HuanJieFaPaiStatisticsInfoServlet  extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			// Excel导出
			String titleName = new TongJiController().exportHuanJieFaPaiStatisticsInfo(type, orgId, beginDate, endDate);
