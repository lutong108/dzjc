...
import com.chinacreator.dzjc_ruleEngine.web.rest.QuanShengYingYongQingKuangStatisticsController;
import com.chinacreator.util.FilesUtil;

public class QuanShengYingYongQingKuangStatisticsInfoServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path = null;
		if ("1".equals(type)) {//导出Word
			
			String titleName = new QuanShengYingYongQingKuangStatisticsController().expWord(beginDate,endDate);
