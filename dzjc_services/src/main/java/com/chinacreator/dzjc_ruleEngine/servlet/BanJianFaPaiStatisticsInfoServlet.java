...
public class BanJianFaPaiStatisticsInfoServlet  extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			// Excel导出
			String titleName = new TongJiController().exportBanJianFaPaiStatisticsInfo(type, orgId, beginDate, endDate);
