...
import com.chinacreator.dzjc_ruleEngine.web.rest.ZwfwInstanceInfoController;
import com.chinacreator.util.FilesUtil;


public class ZwfwInstanceExportServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		String path = null;
		String titleName = new ZwfwInstanceInfoController().excelExport(cond);
