...
public class QuanShengFaPaiStatisticsInfoServlet  extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			// Excel导出
			String titleName = new TongJiController().exportQuanShengFaPaiStatisticsInfo(type, orgId, beginDate, endDate);
