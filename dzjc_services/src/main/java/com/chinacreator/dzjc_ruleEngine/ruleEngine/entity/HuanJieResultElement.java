 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.ruleEngine.entity.HuanJieResultElement", table = "TA_JC_HUANJIE_ELEM_RESULT", ds = "acceptdata", cache = false)
public class HuanJieResultElement {
	/**
	 *要素计算ID
	 */
	 ...
	 *业务类型：1：环节监察
	 */
	@Column(id = "business_type", datatype = "string5")
