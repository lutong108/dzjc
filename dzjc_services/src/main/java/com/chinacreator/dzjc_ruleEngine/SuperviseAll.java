 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.SuperviseAll", table = "V_TA_JC_SUPERVISE_DELETE", ds = "acceptdata", cache = false)
public class SuperviseAll {
	/**
	 *主键id
	 */
	 ...
	 *监察类型编码
	 */
	@Column(id = "supervise_type_no", datatype = "string256")
