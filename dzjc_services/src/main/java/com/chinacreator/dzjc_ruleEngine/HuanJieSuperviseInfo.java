 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_ruleEngine.HuanJieSuperviseInfo", table = "TA_JC_HUANJIE_SUPERVISE_INFO", ds = "acceptdata", cache = false)
public class HuanJieSuperviseInfo {
	/**
