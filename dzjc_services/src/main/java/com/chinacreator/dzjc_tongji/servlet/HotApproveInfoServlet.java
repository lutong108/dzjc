...
import com.chinacreator.dzjc_tongji.web.rest.HotApproveInfoController;
import com.chinacreator.util.FilesUtil;


public class HotApproveInfoServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			// Excel导出
			String titleName = new HotApproveInfoController().exportExcel(cond,tableName,request,response);
