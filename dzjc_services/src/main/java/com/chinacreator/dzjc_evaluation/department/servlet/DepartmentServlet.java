package com.chinacreator.dzjc_evaluation.department.servlet;
...
import com.chinacreator.dzjc_evaluation.department.web.rest.DepartmentController;
...
public class DepartmentServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ("1".equals(type)) {// 1是word
			...
			// 生成excel文件，并返回文件名
			String titleName = new DepartmentController().DepartmentExcel(org_id, tableId, beginDate, endDate);
