 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_performance.EvalComplainReviewe", table = "TA_JC_EVAL_COMPLAIN_REVIEWE", ds = "acceptdata", cache = false)
public class EvalComplainReviewe {
	/**
	 *ID
	 */
