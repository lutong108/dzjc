 ...
 * @generated
 */
@Entity(id = "entity:com.chinacreator.dzjc_dealtMatter.taJcWarningAppeal", table = "TA_JC_WARNING_APPEAL", ds = "acceptdata", cache = false)
public class TaJcWarningAppeal {
	/**
	 *主键ID
	 */
	 ...
	 *处理结果(撤销 C,打回D,上报B)
	 */
	@Column(id = "process_result", datatype = "string64")
