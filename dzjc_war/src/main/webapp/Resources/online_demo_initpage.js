...
function InitMessageBody() {
    ...
    if (MessageBody) {
        var ObjString = "<div class='divinput' style='line-height: 18px;background-color: #C1E5F0;border-radius: 4px;color: #30768D;'><b style='color: #1E586B;'>Note:</b> If you use other server-side language (JSP, PHP, ASP.NET (VB.NET), ASP etc.), you can visit the ";
