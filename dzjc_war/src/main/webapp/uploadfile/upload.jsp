			  ...
			  success: function(data){
				  ...
				  for(var i=0; i<data.length; i++){
					  ...
					  var img = '<img onerror="this.src=\'images/default.png\'" style="height:30px" src="images/'+ type +'.png"/>';
				  	  ...
				  	  var content = '<tr><td height="30" align="center">'+(i+1)+'</td><td>'+obj.attachName+'</td><td align="center">'+new Date(obj.createTime).Format("yyyy-MM-dd hh:mm:ss")+'</td><td align="center">'+img+'</td><td align="center" class="cailiaocaozuo"><a href=\''+url+'\'>下载</a>' + preview +'</td></tr>';
				  	  $("#attachlist tbody").append(content);
				  }
				  $("#downloadli").html("下载("+ data.length +")");
			  }
		});
    }
    ...
    <div class="shengqingren">
		<div class="shengqingrenLeft">
			<ul>
				...
				<li id="downloadli" style="cursor: pointer;" onclick="showApplyDiv(this)">下载</li>
			</ul>
